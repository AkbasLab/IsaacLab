/**
 * rl_tools_adapter.cpp - RL Tools Adapter for Crazyflie Firmware
 * 
 * This file is copied from learning_to_fly_controller for compatibility.
 * It provides the interface between the Crazyflie firmware and trained
 * RL policies in rl_tools checkpoint format.
 * 
 * Key features:
 * - Rotation matrix observation construction (18 dims)
 * - Action history (32 steps × 4 actions = 128 dims)
 * - Total observation: 146 dimensions
 * - Action smoothing at 500Hz (5x control frequency)
 * 
 * Original source: https://github.com/arplaboratory/learning_to_fly_controller
 */
